#!/usr/bin/env python3
"""Stage and optionally package the @growthcircle/growcli npm module."""
...
CODEX_NPM_NAME = "@growthcircle/growcli"
GROWCLI_UNSCOPED_NPM_NAME = "growcli"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `@growthcircle/growcli`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@growthcircle/growcli-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@growthcircle/growcli-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@growthcircle/growcli-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@growthcircle/growcli-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@growthcircle/growcli-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@growthcircle/growcli-win32-arm64",
        "npm_tag": "win32-arm64",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build or stage the Grow CLI npm package.")
    parser.add_argument(
        "--package",
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package in {"codex", "growcli"}:
        if package == "growcli":
            package_json["name"] = GROWCLI_UNSCOPED_NPM_NAME
            bin_entries = package_json.get("bin")
            if isinstance(bin_entries, dict):
                bin_entries.pop("codex", None)
